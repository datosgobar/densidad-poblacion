        ...
        window.onload = function () {
          ...
          var app = function app() {
            ...
            function datos(_datos) {
              ...
              _datos.mapbox.addControl(new mapboxgl.NavigationControl({ position: 'bottom-right' })); // Control de ZOOM
              _datos.mapbox.addControl(new mapboxgl.ScaleControl({ position: 'bottom-left', maxWidth: 80, unit: 'metric' })); // Control de escala
              _datos.mapbox.addControl(new mapboxgl.Geocoder()); // Control Search

              return _datos;
            };
            function dataset(datos) {
              $.get('dataset/datos.geojson', function (file) {
                // Preparar datos
            ...
            function funciones() {
              ...
              function panelIzquierdo() {
                ...
                $('.mapboxgl-ctrl-geocoder.mapboxgl-ctrl').append("<button id='lupa'></button>");
                $("#lupa").append($('.geocoder-icon.geocoder-icon-search'));
          ...
          function render(datos, extras) {
          datos.mapbox.on('load', function (d) {
            // Cargamos datos
          ...
          datos.mapbox.on('mousemove', function (e) {
            ...
            if (features.length) {
              ...
              var selector = '#' + datos.generarReferenciaId(extras.provincias['prov' + features[0].properties.prov_id].nombre);
    ...
    <section class="contenido_app">
      <div class="header_container">
        ...
        <header class="nav_map">
            <div><h1>Explorá como nos distribuimos los Argentinos</h1></div>
            <div>
              <div class="scale_graphic">
                <svg x="0px" y="0px" viewBox="0 0 272.3 27.1">
                	<g>
                		<text transform="matrix(1 0 0 1 219.1693 21.7756)">999999999</text>
                	</g>
                	<g>
                		<text transform="matrix(1 0 0 1 129.9142 21.7756)">0</text>
                	</g>
              		<linearGradient id="scaleColor" gradientUnits="userSpaceOnUse" x1="172.5172" y1="-228.251" x2="314.7942" y2="-228.251" gradientTransform="matrix(1 0 0 1 -43 233.3822)">
                	...
                	<path fill="url(#scaleColor)" d="M129.8,1.1h142v8h-142c-0.2,0-0.3-0.1-0.3-0.3V1.4C129.5,1.3,129.6,1.1,129.8,1.1z"/>
                	<g>
                		<text transform="matrix(1 0 0 1 45.4762 10.2654)">Cantidad de </text>
                		<text transform="matrix(1 0 0 1 8.1745 22.2654)">habitantes por km</text>
                		<text transform="matrix(0.583 0 0 0.583 105.944 18.2693)">2</text>
                	</g>
                	<path d="M39.5,9.9h-9.8c-0.1,0-0.3-0.1-0.3-0.3c0-0.1,0-0.1,0-0.2c-0.1-1,0.5-1.9,1.5-2.2c0.6-0.2,1.2-0.4,1.8-0.6 c0.2-0.1,0.5-0.2,0.7-0.4c0.2-0.1,0.2-0.3,0-0.5C32.7,5,32.3,4,32.3,3c0-1.3,1.2-2.4,2.3-2.3c1.2,0.1,2.2,1.3,2.1,2.5 c-0.1,1-0.5,1.9-1.1,2.6c-0.2,0.2-0.2,0.4,0,0.5c0.2,0.1,0.4,0.3,0.7,0.4c0.6,0.2,1.2,0.4,1.8,0.5c1.1,0.3,1.7,1.3,1.7,2.4 c0,0,0,0,0,0C39.8,9.8,39.6,9.9,39.5,9.9z"/>
                </svg>
              </div>
            </div>
        </header>
      ...
      <section id="container_panel" class="container_panel"><!-- Left Command Panel -->
        <header><h3>Clickeá sobre las capitales de las provincias de Argentina para ver los resultados</h3></header>
        <article>
          <svg id="svgMap" x="0px" y="0px" viewBox="0 0 209.5 336.8">
          	<g id="provs">
          	...
          	<g>
          		...
          		<polygon id="ciudadautonomadebuenosaires" class="prov provhover" points="
